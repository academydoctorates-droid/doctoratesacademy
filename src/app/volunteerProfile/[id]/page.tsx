...
const page = ({ params }) => {
  ...
  useEffect(() => {
    ...
    const getLoginUserDetails = async () => {
      const res = await axios.get(`${BASE_ASSET_URL}/volunteers/${id}`, {
          ...
          >
            ...
            >
              View Pledge
                ...
                <h4 style={{ color: "#ffff" }}>{membershipType}</h4>
              </div>
            </div>
          </div>
                  ...
                  {formData.firstName && (
                    <div>
                      ...
                      >
                        ...
                        {formData.middleName} {formData.familyName}
                      </Typography>
                      <Divider />
                    </div>
                  )}
  ...
  {formData.Contact_phone && (
    <div>
      ...
      <Divider />
                  ...
                  {formData.affilation && (
                    <div>
                      <Typography
                        ...
                        sx={{ lineHeight: 2.43 }}
                      >
                        <span style={{ fontWeight: "bold" }}>Affilation: </span>{" "}
                        {formData.affilation || ""}
                      </Typography>
                      <Divider />
                    </div>
                ...
                <Grid item xs={12} sm={6}>
                  {formData.address_corresponding && (
                    <div>
                      <Typography
                        variant="h5"
                        color="textSecondary"
                ...
                <Grid item xs={12} sm={6}>
                  {formData.Technology_Transferred && (
                    <div>
                      ...
                      >
                        <span style={{ fontWeight: "bold" }}>
                          Technology Transferred* (details):
                        </span>{" "}
                        {formData.Technology_Transferred || ""}
                      </Typography>
                      <Divider />
